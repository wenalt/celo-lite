...
// ⬇️ charge le dialog en client-only pour éviter les erreurs de SSR
...
export default function Home() {
  ...
  // 👉 Thème par défaut = LIGHT (et on respecte une éventuelle préférence enregistrée)
  ...
  // Mini App Farcaster: signal "ready" (no-op si hors client FC)
  useEffect(() => {
    (async () => {
      try {
  ...
  return (
    <>
      ...
      {/* Anti-flash : pose le thème LIGHT avant l’hydratation */}
      <Script id="set-theme" strategy="beforeInteractive">
        {`try{
  var t=localStorage.getItem('celo-lite-theme')||'light';
